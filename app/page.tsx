...
export default function Home() {
  return (
    <main className="min-h-screen bg-midnight-blue flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center space-y-8">
        <div className="space-y-4">
          ...
          <div className="bg-dark-slate border-l-4 border-crimson p-4 text-left rounded">
        ...
        <Link
          href="/generate"
          className="inline-block bg-crimson hover:bg-crimson-dark text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
        >
